# Install PickliPy
## Description
Run this pipeline once to install additional modules required for PickliPy.
For simplicity, PickliPy uses the internal Cellpose environment for, so Cellpose installation is needed - see Help main menu, Primer.
